...
#warning "embedded-trace: SerialTracer included but EMBEDDED_TRACE_ENABLED is not set — TRACE_SCOPE/TRACE_COUNTER will compile to no-ops. Add -DEMBEDDED_TRACE_ENABLED=1 to your build_flags."
#endif
